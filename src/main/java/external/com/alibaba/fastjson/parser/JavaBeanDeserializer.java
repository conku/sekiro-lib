            ...
            try {
                if (fieldClass == int.class) {
                    ...
                    if (fieldInfo.fieldAccess) {
                        ...
                        fieldDeser.setValue(object, Integer.valueOf(intValue));
                    }
                    ...
                    if (fieldInfo.fieldAccess) {
                        ...
                        fieldDeser.setValue(object, Long.valueOf(longValue));
                    }
                    ...
                    if (!valueParsed) {
                        ...
                        if (object == null) {
                            if (fieldClass == int.class || fieldClass == Integer.class) {
                             ...
                             fieldValue = Float.valueOf(fieldValueFloat);
                            } else if (fieldClass == double.class || fieldClass == Double.class) {
                               fieldValue = Double.valueOf(fieldValueDouble);
                            }
                            ...
                            try {
                                if (fieldClass == int.class || fieldClass == Integer.class) {
                                    ...
                                    if (fieldInfo.fieldAccess && fieldClass == float.class) {
                                       ...
                                       fieldDeser.setValue(object, Float.valueOf(fieldValueFloat));
                                    }
                                } else if (fieldClass == double.class || fieldClass == Double.class) {
                                    if (fieldInfo.fieldAccess && fieldClass == double.class) {
                                        fieldDeser.setValue(object, fieldValueDouble);
                                    } else {
                                      fieldDeser.setValue(object, Double.valueOf(fieldValueDouble));
                                    }
                                } else {
