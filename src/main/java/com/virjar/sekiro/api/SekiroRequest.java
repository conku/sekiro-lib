...
import com.virjar.sekiro.api.process.DataprocessInteceptor;
import com.virjar.sekiro.log.SekiroLogger;
import com.virjar.sekiro.utils.Multimap;

public class SekiroRequest {

    private static DataprocessInteceptor dataprocessInteceptor;
    // 请求参数
    ...
    public static void setDataprocessInteceptor(DataprocessInteceptor dataprocessInteceptor0) {
        SekiroRequest.dataprocessInteceptor = dataprocessInteceptor0;
    }
}
